...
// handleClientHandler is the main http websocket handler for the beitel server
func (s *Server) handleClientHandler(w http.ResponseWriter, r *http.Request) {
	//websockets upgrade AND has beitel prefix
...
func (s *Server) handleWebsocket(w http.ResponseWriter, req *http.Request) {
	...
	// beitel server handshake (reverse of client handshake)
